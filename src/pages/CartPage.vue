      ...
      <div v-if="cart.items.length > 0" class="col-8 mt-3">
        <table class="table table-hover text-center">
          ...
          <tbody>
            ...
            <td></td>
            <td></td>
            <td style='text-right'><button type="button" class="btn btn-sm btn-secondary" @click="router.push('/')">
              <mdicon name="home" :height='20'/>Goto Home</button></td>
            <td><button type="button" class="btn btn-sm btn-primary ml-auto">
              <svg width="16px" height="16px" viewBox="0 0 1024 1024" fill="#ffffff" class="icon"  version="1.1" 
